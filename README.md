...
> An intelligent, multi-agent pipeline that reads chemistry research papers (PDFs) and automatically extracts structured experimental data into a formatted Excel spreadsheet — powered by [Claude](https://www.anthropic.com/claude) (Anthropic).
